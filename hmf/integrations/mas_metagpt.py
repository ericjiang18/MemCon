"""MetaGPT — Pure vector similarity retrieval. No LLM calls.
Faithful re-implementation of /home/ubuntu/workplace/GMemory/mas/memory/mas_memory/metagpt.py
"""
...
@dataclass
class MetaGPTMemory(MASMemoryBase):
