...
\begin{table}[t]
\centering
\caption{Task success rate (\%) on interactive benchmarks. \textbf{Bold}: best per row. \ours consistently outperforms G-Memory across frameworks while using fewer tokens.}
\label{tab:main-results}
\small
\begin{tabular}{ll ccc ccc ccc}
\toprule
& & \multicolumn{3}{c}{\textbf{ALFWorld}} & \multicolumn{3}{c}{\textbf{PDDL}} & \multicolumn{3}{c}{\textbf{SciWorld}} \\
\cmidrule(lr){3-5} \cmidrule(lr){6-8} \cmidrule(lr){9-11}
\textbf{Framework} & \textbf{Memory} & Succ. & Tok/T & $\Delta$ & Succ. & Tok/T & $\Delta$ & Succ. & Tok/T & $\Delta$ \\
\midrule
\multirow{3}{*}{Lobster}
  & Empty     & 35.8 & 47K & -- & 40.0 & 46K & -- & 43.0 & 44K & -- \\
  & G-Memory  & 62.7 & 41K & -- & 68.0 & 40K & -- & \textbf{73.0} & 36K & -- \\
  & \ours     & \textbf{67.2} & \textbf{39K} & \cellcolor{mygreen}+4.5 & \textbf{72.0} & \textbf{36K} & \cellcolor{mygreen}+4.0 & 66.0 & \textbf{38K} & -7.0 \\
\midrule
\multirow{3}{*}{LangGraph}
  & Empty     & 35.1 & 47K & -- & 35.0 & 47K & -- & 36.0 & 46K & -- \\
  & G-Memory  & 64.2 & 48K & -- & 64.0 & 43K & -- & 69.0 & 37K & -- \\
  & \ours     & \textbf{67.2} & \textbf{40K} & \cellcolor{mygreen}+3.0 & \textbf{75.0} & \textbf{34K} & \cellcolor{mygreen}+11.0 & \textbf{75.0} & \textbf{36K} & \cellcolor{mygreen}+6.0 \\
\midrule
\multirow{3}{*}{Agent-FW}
  & Empty     & 45.5 & 46K & -- & 54.0 & 44K & -- & 63.0 & 41K & -- \\
  & G-Memory  & \textbf{66.4} & 43K & -- & 73.0 & 39K & -- & 73.0 & 37K & -- \\
  & \ours     & 65.7 & \textbf{44K} & -0.7 & \textbf{74.0} & \textbf{35K} & \cellcolor{mygreen}+1.0 & 73.0 & \textbf{41K} & 0.0 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[t]
\centering
\caption{Accuracy (\%) on QA benchmarks (200 tasks each). Tok/T = average tokens per task. \ours matches or exceeds G-Memory accuracy while using 20--30\% fewer tokens.}
\label{tab:qa-results}
\small
\begin{tabular}{ll ccc ccc}
\toprule
& & \multicolumn{3}{c}{\textbf{TriviaQA}} & \multicolumn{3}{c}{\textbf{WebWalkerQA}} \\
\cmidrule(lr){3-5} \cmidrule(lr){6-8}
\textbf{Framework} & \textbf{Memory} & Acc. & Tok/T & $\Delta$ & Acc. & Tok/T & $\Delta$ \\
\midrule
\multirow{3}{*}{Lobster}
  & Empty     & \textbf{69.5} & 57 & -- & 17.8 & 154 & -- \\
  & G-Memory  & 66.0 & 262 & -- & 18.6 & 360 & -- \\
  & \ours     & \textbf{69.5} & \textbf{208} & \cellcolor{mygreen}+3.5 & \textbf{21.2} & \textbf{341} & \cellcolor{mygreen}+2.6 \\
\midrule
\multirow{3}{*}{LangGraph}
  & Empty     & \textbf{68.5} & 57 & -- & 18.5 & 157 & -- \\
  & G-Memory  & 67.5 & 265 & -- & \textbf{21.2} & 424 & -- \\
  & \ours     & 66.5 & \textbf{195} & -1.0 & 20.2 & \textbf{337} & -1.0 \\
\midrule
\multirow{3}{*}{Agent-FW}
  & Empty     & \textbf{69.0} & 57 & -- & \textbf{19.4} & 155 & -- \\
  & G-Memory  & 68.0 & 263 & -- & 19.2 & 397 & -- \\
  & \ours     & 68.5 & \textbf{187} & \cellcolor{mygreen}+0.5 & 19.0 & \textbf{348} & -0.2 \\
\bottomrule
\end{tabular}
\end{table}
